...
function build_release() {
  ...
  export ARTIFACTS_TO_PUBLISH=("${EVENTING_KAFKA_ARTIFACT} ${EVENTING_KAFKA_CONTROL_PLANE_ARTIFACT} ${EVENTING_KAFKA_SOURCE_ARTIFACT} ${EVENTING_KAFKA_BROKER_ARTIFACT} ${EVENTING_KAFKA_SINK_ARTIFACT} ${EVENTING_KAFKA_CHANNEL_ARTIFACT}")
}
