...
func Get(ctx context.Context, selector string) externalversions.SharedInformerFactory {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch knative.dev/eventing-kafka-broker/third_party/pkg/client/informers/externalversions.SharedInformerFactory with selector %s from context.", selector)
	}
