...
replace (
	...
	// FIXME: remove this pin when knative-sandbox/eventing-kafka#1213 is merged
	knative.dev/eventing-kafka => github.com/cardil/knative-eventing-kafka v0.21.1-0.20220720215349-15a03aadf676
