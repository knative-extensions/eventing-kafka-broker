...
const (
	DeliveryGuarantee_ORDERED   DeliveryGuarantee = 0
	DeliveryGuarantee_UNORDERED DeliveryGuarantee = 1
)
...
type Egress struct {
	...
	DeliveryGuarantee DeliveryGuarantee `protobuf:"varint,8,opt,name=deliveryGuarantee,proto3,enum=DeliveryGuarantee" json:"deliveryGuarantee,omitempty"`
}
...
func (x *Egress) GetDeliveryGuarantee() DeliveryGuarantee {
	if x != nil {
		return x.DeliveryGuarantee
	}
	return DeliveryGuarantee_ORDERED
}
...
var file_proto_def_contract_proto_rawDesc = []byte{
	...
	0x61, 0x63, 0x6b, 0x6f, 0x66, 0x66, 0x44, 0x65, 0x6c, 0x61, 0x79, 0x22, 0xf5, 0x02, 0x0a, 0x06,
	...
	0x12, 0x40, 0x0a, 0x11, 0x64, 0x65, 0x6c, 0x69, 0x76, 0x65, 0x72, 0x79, 0x47, 0x75, 0x61, 0x72,
	0x61, 0x6e, 0x74, 0x65, 0x65, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x12, 0x2e, 0x44, 0x65,
	...
	0x65, 0x65, 0x42, 0x0f, 0x0a, 0x0d, 0x72, 0x65, 0x70, 0x6c, 0x79, 0x53, 0x74, 0x72, 0x61, 0x74,
	...
	0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0xcc, 0x02, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x6f, 0x75,
	...
	0x65, 0x73, 0x73, 0x65, 0x73, 0x12, 0x38, 0x0a, 0x0a, 0x61, 0x62, 0x73, 0x65, 0x6e, 0x74, 0x41,
	0x75, 0x74, 0x68, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x67, 0x6f, 0x6f, 0x67,
	...
	0x4c, 0x69, 0x6e, 0x65, 0x61, 0x72, 0x10, 0x01, 0x2a, 0x2f, 0x0a, 0x11, 0x44, 0x65, 0x6c, 0x69,
	0x76, 0x65, 0x72, 0x79, 0x47, 0x75, 0x61, 0x72, 0x61, 0x6e, 0x74, 0x65, 0x65, 0x12, 0x0b, 0x0a,
	0x07, 0x4f, 0x52, 0x44, 0x45, 0x52, 0x45, 0x44, 0x10, 0x00, 0x12, 0x0d, 0x0a, 0x09, 0x55, 0x4e,
...
var file_proto_def_contract_proto_goTypes = []interface{}{
	...
	(DeliveryGuarantee)(0), // 1: DeliveryGuarantee
...
var file_proto_def_contract_proto_depIdxs = []int32{
	...
	1,  // 5: Egress.deliveryGuarantee:type_name -> DeliveryGuarantee
