...
var file_contract_proto_rawDesc = []byte{
	...
	0x73, 0x22, 0xff, 0x02, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x12, 0x10,
	...
	0x69, 0x41, 0x75, 0x74, 0x68, 0x53, 0x65, 0x63, 0x72, 0x65, 0x74, 0x42, 0x06, 0x0a, 0x04, 0x41,
...
var file_contract_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_contract_proto_goTypes = []interface{}{
	...
	(*Resource)(nil),             // 15: Resource
	(*Contract)(nil),             // 16: Contract
	nil,                          // 17: Filter.AttributesEntry
}
var file_contract_proto_depIdxs = []int32{
	17, // 0: Filter.attributes:type_name -> Filter.AttributesEntry
	...
	10, // 14: Resource.ingress:type_name -> Ingress
	8,  // 15: Resource.egressConfig:type_name -> EgressConfig
	9,  // 16: Resource.egresses:type_name -> Egress
	6,  // 17: Resource.absentAuth:type_name -> Empty
	11, // 18: Resource.authSecret:type_name -> Reference
	14, // 19: Resource.multiAuthSecret:type_name -> MultiSecretReference
	15, // 20: Contract.resources:type_name -> Resource
