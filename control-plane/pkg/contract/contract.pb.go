...
var file_contract_proto_rawDesc = []byte{
	...
	0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x22, 0x87, 0x03, 0x0a, 0x06, 0x45, 0x67, 0x72, 0x65,
	...
	0x65, 0x73, 0x73, 0x54, 0x79, 0x70, 0x65, 0x22, 0x6b, 0x0a, 0x09, 0x52, 0x65, 0x66, 0x65, 0x72,
	...
	0x73, 0x69, 0x6f, 0x6e, 0x22, 0xbc, 0x02, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63,
	...
	0x0a, 0x61, 0x75, 0x74, 0x68, 0x53, 0x65, 0x63, 0x72, 0x65, 0x74, 0x42, 0x06, 0x0a, 0x04, 0x41,
	...
	0x44, 0x10, 0x01, 0x2a, 0x29, 0x0a, 0x0b, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x4d, 0x6f,
...
var file_contract_proto_depIdxs = []int32{
	...
	3,  // 3: Egress.discardReply:type_name -> Empty
	4,  // 4: Egress.filter:type_name -> Filter
	5,  // 5: Egress.egressConfig:type_name -> EgressConfig
	1,  // 6: Egress.deliveryOrder:type_name -> DeliveryOrder
	2,  // 7: Ingress.contentMode:type_name -> ContentMode
	7,  // 8: Resource.ingress:type_name -> Ingress
	5,  // 9: Resource.egressConfig:type_name -> EgressConfig
	6,  // 10: Resource.egresses:type_name -> Egress
	3,  // 11: Resource.absentAuth:type_name -> Empty
	8,  // 12: Resource.authSecret:type_name -> Reference
	9,  // 13: Contract.resources:type_name -> Resource
