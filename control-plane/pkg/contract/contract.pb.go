...
func (x *CESOL) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CESOL) ProtoMessage() {}

func (x *CESOL) ProtoReflect() protoreflect.Message {
	mi := &file_contract_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CESOL.ProtoReflect.Descriptor instead.
func (*CESOL) Descriptor() ([]byte, []int) {
	return file_contract_proto_rawDescGZIP(), []int{7}
}

func (x *CESOL) GetExpression() string {
	if x != nil {
		return x.Expression
	}
	return ""
...
func (x *DialectedFilter) GetCesql() *CESOL {
...
type DialectedFilter_Cesql struct {
	Cesql *CESOL `protobuf:"bytes,7,opt,name=cesql,proto3,oneof"`
}
...
var file_contract_proto_rawDesc = []byte{
	...
	0x22, 0x27, 0x0a, 0x05, 0x43, 0x45, 0x53, 0x4f, 0x4c, 0x12, 0x1e, 0x0a, 0x0a, 0x65, 0x78, 0x70,
	...
	0x32, 0x06, 0x2e, 0x43, 0x45, 0x53, 0x4f, 0x4c, 0x48, 0x00, 0x52, 0x05, 0x63, 0x65, 0x73, 0x71,
...
var file_contract_proto_depIdxs = []int32{
	...
	13, // 10: DialectedFilter.cesql:type_name -> CESOL
