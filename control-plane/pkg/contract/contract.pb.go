...
type EgressConfig struct {
	...
	BackoffDelay string `protobuf:"bytes,4,opt,name=backoffDelay,proto3" json:"backoffDelay,omitempty"`
}
...
func (x *EgressConfig) GetBackoffDelay() string {
	if x != nil {
...
var file_proto_def_contract_proto_rawDesc = []byte{
	...
	0x66, 0x66, 0x44, 0x65, 0x6c, 0x61, 0x79, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x62,
