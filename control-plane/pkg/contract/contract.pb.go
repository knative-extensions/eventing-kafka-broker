...
type Ingress struct {
	...
	EventTypeOwnerReference *Reference `protobuf:"bytes,5,opt,name=eventTypeOwnerReference,proto3" json:"eventTypeOwnerReference,omitempty"`
}
...
func (x *Ingress) GetEventTypeOwnerReference() *Reference {
	if x != nil {
		return x.EventTypeOwnerReference
	}
	return nil
}
...
var file_contract_proto_rawDesc = []byte{
	...
	0x75, 0x74, 0x6f, 0x72, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x22, 0xe7, 0x01, 0x0a, 0x07,
	...
	0x72, 0x65, 0x61, 0x74, 0x65, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65, 0x73, 0x12,
	0x44, 0x0a, 0x17, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65, 0x4f, 0x77, 0x6e, 0x65,
	0x72, 0x52, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x0a, 0x2e, 0x52, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x52, 0x17, 0x65, 0x76,
	0x65, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65, 0x4f, 0x77, 0x6e, 0x65, 0x72, 0x52, 0x65, 0x66, 0x65,
	0x72, 0x65, 0x6e, 0x63, 0x65, 0x22, 0x7f, 0x0a, 0x09, 0x52, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e,
	...
	0x52, 0x04, 0x6b, 0x69, 0x6e, 0x64, 0x22, 0x7f, 0x0a, 0x0f, 0x53, 0x65, 0x63, 0x72, 0x65, 0x74,
...
var file_contract_proto_depIdxs = []int32{
	...
	20, // 25: Ingress.eventTypeOwnerReference:type_name -> Reference
	20, // 26: SecretReference.reference:type_name -> Reference
	22, // 27: SecretReference.keyFieldReferences:type_name -> KeyFieldReference
	4,  // 28: KeyFieldReference.field:type_name -> SecretField
	5,  // 29: MultiSecretReference.protocol:type_name -> Protocol
	21, // 30: MultiSecretReference.references:type_name -> SecretReference
	31, // 31: CloudEventOverrides.extensions:type_name -> CloudEventOverrides.ExtensionsEntry
	19, // 32: Resource.ingress:type_name -> Ingress
	...
	20, // 36: Resource.authSecret:type_name -> Reference
	23, // 37: Resource.multiAuthSecret:type_name -> MultiSecretReference
	24, // 38: Resource.cloudEventOverrides:type_name -> CloudEventOverrides
	20, // 39: Resource.reference:type_name -> Reference
	25, // 40: Contract.resources:type_name -> Resource
