...
var file_contract_proto_rawDesc = []byte{
	...
	0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0xbc, 0x02, 0x0a, 0x08, 0x52, 0x65, 0x73,
	...
	0x65, 0x48, 0x00, 0x52, 0x0a, 0x61, 0x75, 0x74, 0x68, 0x53, 0x65, 0x63, 0x72, 0x65, 0x74, 0x42,
	...
	0x01, 0x42, 0x5b, 0x0a, 0x2a, 0x64, 0x65, 0x76, 0x2e, 0x6b, 0x6e, 0x61, 0x74, 0x69, 0x76, 0x65,
...
var file_contract_proto_goTypes = []interface{}{
	...
	(*Empty)(nil),        // 4: Empty
	(*Filter)(nil),       // 5: Filter
	(*EgressConfig)(nil), // 6: EgressConfig
	(*Egress)(nil),       // 7: Egress
	(*Ingress)(nil),      // 8: Ingress
	(*Reference)(nil),    // 9: Reference
	(*Resource)(nil),     // 10: Resource
	(*Contract)(nil),     // 11: Contract
	nil,                  // 12: Filter.AttributesEntry
}
var file_contract_proto_depIdxs = []int32{
	12, // 0: Filter.attributes:type_name -> Filter.AttributesEntry
	0,  // 1: EgressConfig.backoffPolicy:type_name -> BackoffPolicy
	4,  // 2: Egress.replyToOriginalTopic:type_name -> Empty
	4,  // 3: Egress.discardReply:type_name -> Empty
	5,  // 4: Egress.filter:type_name -> Filter
	6,  // 5: Egress.egressConfig:type_name -> EgressConfig
	...
	8,  // 9: Resource.ingress:type_name -> Ingress
	6,  // 10: Resource.egressConfig:type_name -> EgressConfig
	7,  // 11: Resource.egresses:type_name -> Egress
	4,  // 12: Resource.absentAuth:type_name -> Empty
	9,  // 13: Resource.authSecret:type_name -> Reference
	10, // 14: Contract.resources:type_name -> Resource
