...
func (x *Egress) GetDeadLetter() string {
	if x != nil {
		return x.DeadLetter
	}
	return ""
...
var file_proto_def_contract_proto_rawDesc = []byte{
	...
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x8e, 0x02, 0x0a, 0x06, 0x45,
	...
	0x69, 0x6e, 0x61, 0x6c, 0x54, 0x6f, 0x70, 0x69, 0x63, 0x12, 0x1e, 0x0a, 0x0a, 0x64, 0x65, 0x61,
	0x64, 0x4c, 0x65, 0x74, 0x74, 0x65, 0x72, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x64,
	0x65, 0x61, 0x64, 0x4c, 0x65, 0x74, 0x74, 0x65, 0x72, 0x12, 0x1f, 0x0a, 0x06, 0x66, 0x69, 0x6c,
	0x74, 0x65, 0x72, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x07, 0x2e, 0x46, 0x69, 0x6c, 0x74,
	...
	0x65, 0x22, 0xa7, 0x01, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x12, 0x0e,
	...
	0x6e, 0x67, 0x72, 0x65, 0x73, 0x73, 0x12, 0x23, 0x0a, 0x08, 0x65, 0x67, 0x72, 0x65, 0x73, 0x73,
	0x65, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x07, 0x2e, 0x45, 0x67, 0x72, 0x65, 0x73,
	0x73, 0x52, 0x08, 0x65, 0x67, 0x72, 0x65, 0x73, 0x73, 0x65, 0x73, 0x22, 0x53, 0x0a, 0x08, 0x43,
	...
	0x54, 0x52, 0x55, 0x43, 0x54, 0x55, 0x52, 0x45, 0x44, 0x10, 0x01, 0x42, 0x5b, 0x0a, 0x2a, 0x64,
...
var file_proto_def_contract_proto_goTypes = []interface{}{
	...
	(*Filter)(nil),      // 1: Filter
	(*Egress)(nil),      // 2: Egress
	(*Ingress)(nil),     // 3: Ingress
	(*Resource)(nil),    // 4: Resource
	(*Contract)(nil),    // 5: Contract
	nil,                 // 6: Filter.AttributesEntry
	(*empty.Empty)(nil), // 7: google.protobuf.Empty
}
var file_proto_def_contract_proto_depIdxs = []int32{
	6, // 0: Filter.attributes:type_name -> Filter.AttributesEntry
	7, // 1: Egress.replyToOriginalTopic:type_name -> google.protobuf.Empty
	1, // 2: Egress.filter:type_name -> Filter
	0, // 3: Ingress.contentMode:type_name -> ContentMode
	3, // 4: Resource.ingress:type_name -> Ingress
	2, // 5: Resource.egresses:type_name -> Egress
	4, // 6: Contract.resources:type_name -> Resource
...
func file_proto_def_contract_proto_init() {
	...
	file_proto_def_contract_proto_msgTypes[1].OneofWrappers = []interface{}{
		(*Egress_ReplyUrl)(nil),
