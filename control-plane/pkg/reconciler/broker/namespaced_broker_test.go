	...
	table := TableTest{
		{
			...
			Objects: []runtime.Object{
				...
				reconcilertesting.NewStatefulSet("kafka-broker-receiver", SystemNamespace),
				reconcilertesting.NewStatefulSet("kafka-broker-dispatcher", SystemNamespace),
...
`,
			...
			WantCreates: []runtime.Object{
				...
				ToManifestivalResource(t,
					reconcilertesting.NewStatefulSet("kafka-broker-receiver", BrokerNamespace),
					WithNamespacedBrokerOwnerRef,
					WithNamespacedLabel,
				),
				ToManifestivalResource(t,
					reconcilertesting.NewStatefulSet("kafka-broker-dispatcher", BrokerNamespace),
					WithNamespacedBrokerOwnerRef,
					WithNamespacedLabel,
				),
				ToManifestivalResource(t,
