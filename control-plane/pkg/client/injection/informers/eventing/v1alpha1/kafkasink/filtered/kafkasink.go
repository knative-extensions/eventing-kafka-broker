...
func Get(ctx context.Context, selector string) v1alpha1.KafkaSinkInformer {
	untyped := ctx.Value(Key{Selector: selector})
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch knative.dev/eventing-kafka-broker/control-plane/pkg/client/informers/externalversions/eventing/v1alpha1.KafkaSinkInformer with selector %s from context.", selector)
	}
