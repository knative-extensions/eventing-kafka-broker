...
func Get(ctx context.Context) v1beta1.KafkaBindingInformer {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch knative.dev/eventing-kafka-broker/control-plane/pkg/client/informers/externalversions/bindings/v1beta1.KafkaBindingInformer from context.")
	}
