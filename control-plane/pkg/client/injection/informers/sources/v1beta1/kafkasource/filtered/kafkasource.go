...
func Get(ctx context.Context, selector string) v1beta1.KafkaSourceInformer {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch knative.dev/eventing-kafka-broker/control-plane/pkg/client/informers/externalversions/sources/v1beta1.KafkaSourceInformer with selector %s from context.", selector)
	}
