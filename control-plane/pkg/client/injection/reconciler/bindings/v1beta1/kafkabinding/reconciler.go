...
func (r *reconcilerImpl) updateFinalizersFilteredServerSideApply(ctx context.Context, resource *v1beta1.KafkaBinding, desiredFinalizers sets.Set[string]) (*v1beta1.KafkaBinding, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredMergePatch(ctx context.Context, resource *v1beta1.KafkaBinding, desiredFinalizers sets.Set[string]) (*v1beta1.KafkaBinding, error) {
	// Don't modify the informers copy.
...
func (r *reconcilerImpl) clearFinalizer(ctx context.Context, resource *v1beta1.KafkaBinding, reconcileEvent reconciler.Event) (*v1beta1.KafkaBinding, error) {
	...
	if err != nil {
		...
		getter := r.Client.BindingsV1beta1().KafkaBindings(resource.Namespace)
