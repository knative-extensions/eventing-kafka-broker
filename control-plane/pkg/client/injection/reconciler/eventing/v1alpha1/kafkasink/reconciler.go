...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1alpha1.KafkaSink, desired *v1alpha1.KafkaSink) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.KafkaSink, desiredFinalizers sets.Set[string]) (*v1alpha1.KafkaSink, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredServerSideApply(ctx context.Context, resource *v1alpha1.KafkaSink, desiredFinalizers sets.Set[string]) (*v1alpha1.KafkaSink, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredMergePatch(ctx context.Context, resource *v1alpha1.KafkaSink, desiredFinalizers sets.Set[string]) (*v1alpha1.KafkaSink, error) {
	// Don't modify the informers copy.
...
func (r *reconcilerImpl) clearFinalizer(ctx context.Context, resource *v1alpha1.KafkaSink, reconcileEvent reconciler.Event) (*v1alpha1.KafkaSink, error) {
	...
	if err != nil {
		...
		getter := r.Client.EventingV1alpha1().KafkaSinks(resource.Namespace)
