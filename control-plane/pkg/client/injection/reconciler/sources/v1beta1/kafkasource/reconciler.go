...
func (r *reconcilerImpl) updateFinalizersFilteredServerSideApply(ctx context.Context, resource *v1beta1.KafkaSource, desiredFinalizers sets.Set[string]) (*v1beta1.KafkaSource, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredMergePatch(ctx context.Context, resource *v1beta1.KafkaSource, desiredFinalizers sets.Set[string]) (*v1beta1.KafkaSource, error) {
	// Don't modify the informers copy.
...
func (r *reconcilerImpl) clearFinalizer(ctx context.Context, resource *v1beta1.KafkaSource, reconcileEvent reconciler.Event) (*v1beta1.KafkaSource, error) {
	...
	if err != nil {
		...
		getter := r.Client.SourcesV1beta1().KafkaSources(resource.Namespace)
