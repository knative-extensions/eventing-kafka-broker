...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1beta1.KafkaChannel, desiredFinalizers sets.Set[string]) (*v1beta1.KafkaChannel, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredServerSideApply(ctx context.Context, resource *v1beta1.KafkaChannel, desiredFinalizers sets.Set[string]) (*v1beta1.KafkaChannel, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredMergePatch(ctx context.Context, resource *v1beta1.KafkaChannel, desiredFinalizers sets.Set[string]) (*v1beta1.KafkaChannel, error) {
	// Don't modify the informers copy.
...
func (r *reconcilerImpl) clearFinalizer(ctx context.Context, resource *v1beta1.KafkaChannel, reconcileEvent reconciler.Event) (*v1beta1.KafkaChannel, error) {
	...
	if err != nil {
		...
		getter := r.Client.MessagingV1beta1().KafkaChannels(resource.Namespace)
