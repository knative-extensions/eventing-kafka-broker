...
var kafkachannelsResource = v1beta1.SchemeGroupVersion.WithResource("kafkachannels")

var kafkachannelsKind = v1beta1.SchemeGroupVersion.WithKind("KafkaChannel")
...
func (c *FakeKafkaChannels) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.KafkaChannel, err error) {
	emptyResult := &v1beta1.KafkaChannel{}
	obj, err := c.Fake.
...
func (c *FakeKafkaChannels) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.KafkaChannelList, err error) {
	emptyResult := &v1beta1.KafkaChannelList{}
	obj, err := c.Fake.
...
func (c *FakeKafkaChannels) UpdateStatus(ctx context.Context, kafkaChannel *v1beta1.KafkaChannel, opts v1.UpdateOptions) (result *v1beta1.KafkaChannel, err error) {
	emptyResult := &v1beta1.KafkaChannel{}
	obj, err := c.Fake.
