...
type KafkaChannelLister interface {
	...
	List(selector labels.Selector) (ret []*messagingv1.KafkaChannel, err error)
...
type kafkaChannelLister struct {
	listers.ResourceIndexer[*messagingv1.KafkaChannel]
}
...
func NewKafkaChannelLister(indexer cache.Indexer) KafkaChannelLister {
	return &kafkaChannelLister{listers.New[*messagingv1.KafkaChannel](indexer, messagingv1.Resource("kafkachannel"))}
}

// KafkaChannels returns an object that can list and get KafkaChannels.
func (s *kafkaChannelLister) KafkaChannels(namespace string) KafkaChannelNamespaceLister {
	return kafkaChannelNamespaceLister{listers.NewNamespaced[*messagingv1.KafkaChannel](s.ResourceIndexer, namespace)}
}
...
type KafkaChannelNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*messagingv1.KafkaChannel, error)
