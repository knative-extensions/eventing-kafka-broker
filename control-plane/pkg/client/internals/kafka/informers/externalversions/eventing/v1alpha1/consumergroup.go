...
import (
	...
	eventingv1alpha1 "knative.dev/eventing-kafka-broker/control-plane/pkg/apis/internals/kafka/eventing/v1alpha1"
	versioned "knative.dev/eventing-kafka-broker/control-plane/pkg/client/internals/kafka/clientset/versioned"
	internalinterfaces "knative.dev/eventing-kafka-broker/control-plane/pkg/client/internals/kafka/informers/externalversions/internalinterfaces"
	v1alpha1 "knative.dev/eventing-kafka-broker/control-plane/pkg/client/internals/kafka/listers/eventing/v1alpha1"
)
...
func NewFilteredConsumerGroupInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(
		...
		&eventingv1alpha1.ConsumerGroup{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *consumerGroupInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&eventingv1alpha1.ConsumerGroup{}, f.defaultInformer)
}
