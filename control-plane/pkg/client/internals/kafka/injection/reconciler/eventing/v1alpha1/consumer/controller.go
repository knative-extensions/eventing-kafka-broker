...
import (
	...
	consumer "knative.dev/eventing-kafka-broker/control-plane/pkg/client/internals/kafka/injection/informers/eventing/v1alpha1/consumer"
...
const (
	defaultControllerAgentName = "consumer-controller"
	defaultFinalizerName       = "consumers.internal.kafka.eventing.knative.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	lister := consumerInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "internal.kafka.eventing.knative.dev.Consumer"),
	)
