...
func (r *reconcilerImpl) updateStatus(ctx context.Context, existing *v1alpha1.Consumer, desired *v1alpha1.Consumer) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.Consumer) (*v1alpha1.Consumer, error) {

	getter := r.Lister.Consumers(resource.Namespace)
