...
import (
	...
	versionedscheme "knative.dev/eventing-kafka-broker/control-plane/pkg/client/internals/kafka/clientset/versioned/scheme"
	client "knative.dev/eventing-kafka-broker/control-plane/pkg/client/internals/kafka/injection/client"
	consumergroup "knative.dev/eventing-kafka-broker/control-plane/pkg/client/internals/kafka/injection/informers/eventing/v1alpha1/consumergroup"
...
const (
	defaultControllerAgentName = "consumergroup-controller"
	defaultFinalizerName       = "consumergroups.internal.kafka.eventing.knative.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	lister := consumergroupInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "internal.kafka.eventing.knative.dev.ConsumerGroup"),
	)
