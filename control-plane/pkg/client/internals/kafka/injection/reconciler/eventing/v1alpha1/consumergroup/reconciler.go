...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.ConsumerGroup, desiredFinalizers sets.String) (*v1alpha1.ConsumerGroup, error) {
	// Don't modify the informers copy.
