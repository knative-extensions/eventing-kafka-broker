...
func (r *reconcilerImpl) updateStatus(ctx context.Context, existing *v1alpha1.ConsumerGroup, desired *v1alpha1.ConsumerGroup) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.ConsumerGroup) (*v1alpha1.ConsumerGroup, error) {

	getter := r.Lister.ConsumerGroups(resource.Namespace)
