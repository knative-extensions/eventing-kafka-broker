...
public class ReceiverVerticle extends AbstractVerticle implements Handler<HttpServerRequest> {
  ...
  private final String SECRET_VOLUME_PATH;
  private final String TLS_KEY_FILE_PATH;
  private final String TLS_CRT_FILE_PATH;
  ...
  public ReceiverVerticle(
    ...
    this.SECRET_VOLUME_PATH = secretVolumePath;
