...
public class AnyFilterTest {
    ...
    static Stream<Arguments> testCases() {
        return Stream.of(
                Arguments.of(event, new AnyFilter(ImmutableList.of(new ExactFilter(Map.of("id", "123-42"))), vertx, 500), true),
                Arguments.of(
                        event,
                        new AnyFilter(
                                ImmutableList.of(
                ...
                Arguments.of(
                        ...
                        new AnyFilter(
                                ...
                                500),
                        false),
                Arguments.of(event, new AnyFilter(ImmutableList.of(), vertx, 500), false));
    }
}
