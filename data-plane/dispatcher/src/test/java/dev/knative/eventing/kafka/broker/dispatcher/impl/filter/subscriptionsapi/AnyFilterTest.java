...
public class AnyFilterTest {
  ...
  static Stream<Arguments> testCases() {
    return Stream.of(
      ...
      Arguments.of(event, new AnyFilter(Set.of(new ExactFilter(Map.of("id", "123-42")), new ExactFilter(Map.of("source", "/api/some-source")))), true),
      Arguments.of(event, new AnyFilter(Set.of(new ExactFilter(Map.of("id", "123")), new ExactFilter(Map.of("source", "/api/some-source")))), true),
      Arguments.of(event, new AnyFilter(Set.of(new ExactFilter(Map.of("id", "123-42")), new ExactFilter(Map.of("source", "/api/something-else")))), true),
      Arguments.of(event, new AnyFilter(Set.of(new ExactFilter(Map.of("id", "123")), new ExactFilter(Map.of("source", "/api/something-else")))), false),
