...
public class DeserializersInterceptorTest {
        ...
        return Stream.of(
                ...
                TestCase.builder()
                        ...
                        .setExpectedEvent(CloudEventBuilder.v1()
                                ...
                                .withSource(URI.create(
                                        "/apis/v1/namespaces/%s/kafkasources/%s#%s".formatted("ns", "ks", "t1")))
                ...
                TestCase.builder()
                        .setConfigs(Map.of(
                                ...
                                INVALID_CE_WRAPPER_ENABLED, "true"))
                        .setHeaders(
                                new RecordHeaders().add("content-type", "text/plain".getBytes(StandardCharsets.UTF_8)))
                        .setTopic("t1")
                        .setKey("0".getBytes(StandardCharsets.UTF_8))
                        .setExpectedKey("0")
    ...
    static class TestCase {
        ...
        Map.Entry<Object, CloudEvent> keyValueUsing(
                final KeyDeserializer keyDeserializer, final CloudEventDeserializer cloudEventDeserializer) {
            if (headers == null) {
                return new AbstractMap.SimpleImmutableEntry<>(
                        keyDeserializer.deserialize(topic, key), cloudEventDeserializer.deserialize(topic, value));
            }
            return new AbstractMap.SimpleImmutableEntry<>(
    ...
    public static class TestCaseBuilder {
        ...
        public DeserializersInterceptorTest.TestCase build() {
            return new DeserializersInterceptorTest.TestCase(
                    configs, topic, headers, value, key, expectedEvent, expectedKey);
        }
    }
}
