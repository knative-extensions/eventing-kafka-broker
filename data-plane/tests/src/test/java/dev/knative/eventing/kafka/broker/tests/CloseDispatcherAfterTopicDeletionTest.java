...
public class CloseDispatcherAfterTopicDeletionTest {
  ...
  public void execute(final Vertx vertx, final VertxTestContext context) throws InterruptedException, ExecutionException {
    ...
    LoggerFactory.getLogger(CloseDispatcherAfterTopicDeletionTest.class).info("Consumer undeployed");
