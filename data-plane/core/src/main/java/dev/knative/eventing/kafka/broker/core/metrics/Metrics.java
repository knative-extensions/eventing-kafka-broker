...
public class Metrics {
   ...
   */
  public static final String EVENT_DISPATCH_IN_FLIGHT_REQUESTS_LATENCY =
  ...
  private static String getHost() {
    ...
    if (host == null) {
      logger.info(
          "Metrics server host wasn't provided, using default value "
              + HttpServerOptions.DEFAULT_HOST);
  ...
  public static DistributionSummary.Builder eventDispatchLatency(
  ...
  public static Gauge.Builder<Supplier<Number>> eventDispatchInFlightCount(
    ...
    return Gauge.builder(EVENT_DISPATCH_IN_FLIGHT_REQUESTS_LATENCY, supplier)
        .description(
            "Number of events currently dispatched to a destination waiting to be processed")
        .tags(tags)
        .baseUnit(Units.DIMENSIONLESS);
  }

  public static DistributionSummary.Builder eventProcessingLatency(
      final io.micrometer.core.instrument.Tags tags) {
  ...
  public static DistributionSummary.Builder executorQueueLatency(
      final io.micrometer.core.instrument.Tags tags) {
  ...
  public static io.micrometer.core.instrument.Tags resourceRefTags(
  ...
  public static io.micrometer.core.instrument.Tags egressRefTags(
      final DataPlaneContract.Reference ref) {
    return io.micrometer.core.instrument.Tags.of(
