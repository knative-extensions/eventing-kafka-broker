...
public class ResourcesReconcilerBuilder {
    ...
    public ResourcesReconcilerBuilder watchIngress(IngressReconcilerListener ingressReconcilerListener) {
        Objects.requireNonNull(ingressReconcilerListener);
        this.ingressReconcilerListener = ingressReconcilerListener;
        return this;
    }

    public ResourcesReconcilerBuilder watchEgress(EgressReconcilerListener egressReconcilerListener) {
