...
public class KReference implements KubernetesResource {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.getApiVersion(), that.getApiVersion()) && Objects.equals(this.getKind(), that.getKind()) && Objects.equals(this.getName(), that.getName()) && Objects.equals(this.getNamespace(), that.getNamespace());
  }
