...
class ResourcesReconcilerImplTest {
    ...
    void nullPointerExceptionWhenNoListenerIsProvided() {
        assertThatThrownBy(() -> ResourcesReconciler.builder().build()).isInstanceOf(NullPointerException.class);
    }
    ...
    void reconcileIngressAddNewResourcesWithoutIngress() {
        new ResourceReconcilerTestRunner()
                ...
                .reconcile(List.of(
                        baseResource("1-1234").build(), baseResource("2-1234").build()))
                .run();
    }
    ...
    void reconcileIngressAddNewIngressAtSecondStep() {
        new ResourceReconcilerTestRunner()
                ...
                .reconcile(List.of(
                        baseResource("1-1234")
                                .setIngress(
                                        DataPlaneContract.Ingress.newBuilder().setPath("/hello"))
                                .build(),
    ...
    void reconcileEgressModifyingTheResource() {
        new ResourceReconcilerTestRunner()
                ...
                .reconcile(List.of(baseResource("1-1234")
                        .addEgresses(egress("aaa"))
                        .addEgresses(
                                baseEgress("bbb").setFilter(Filter.newBuilder().putAttributes("id", "hello")))
                        .addEgresses(egress("ccc"))
                        .build()))
                .expect()
                .updatedEgress("bbb")
    ...
    void reconcileEgressModifyingTheResourceWithDialectedFilters() {
        new ResourceReconcilerTestRunner()
                ...
                .reconcile(List.of(baseResource("1-1234")
                        .addEgresses(egress("aaa"))
                        .addEgresses(baseEgress("bbb")
                                .addDialectedFilter(DataPlaneContract.DialectedFilter.newBuilder()
                                        .setExact(DataPlaneContract.Exact.newBuilder()
                                                .putAttributes("id", "hello")
                                                .build())))
                        .addEgresses(baseEgress("ccc")
                                .addDialectedFilter(DataPlaneContract.DialectedFilter.newBuilder()
                                        .setPrefix(DataPlaneContract.Prefix.newBuilder()
                                                .putAttributes("source", "dev.knative")
                                                .build())))
                        .addEgresses(baseEgress("ddd")
                                .addDialectedFilter(DataPlaneContract.DialectedFilter.newBuilder()
                                        .getAllBuilder()
                                        .addFiltersBuilder()
                                        .setPrefix(DataPlaneContract.Prefix.newBuilder()
    ...
    @Test
    public void reconcileEgressTrustBundle() {
        new ResourceReconcilerTestRunner()
                .enableEgressListener()
                .reconcile(List.of(baseResource("1")
                        .addEgresses(egress("aaa"))
                ...
                .reconcile(DataPlaneContract.Contract.newBuilder()
                        .addTrustBundles("CERTIFICATE1")
                        .addAllResources(List.of(baseResource("1")
                                .addEgresses(egress("aaa"))
                                .addEgresses(egress("bbb"))
                                .addEgresses(egress("ccc"))
                                .build()))
